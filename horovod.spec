...
%prep
%setup -q -n horovod-0.19.5
cd %{_builddir}/horovod-0.19.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593097246
...
cp %{_builddir}/horovod-0.19.5/LICENSE %{buildroot}/usr/share/package-licenses/horovod/bbce9e5e2c16889a1fdf197556e6b052e337a895
cp %{_builddir}/horovod-0.19.5/third_party/lbfgs/LICENSE.md %{buildroot}/usr/share/package-licenses/horovod/5fc0d512fe8797e2ba125c646447ce451689a129
