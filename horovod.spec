...
Source0  : https://files.pythonhosted.org/packages/21/38/eb90f95f73fb352c662b642c54785b6abadaf2d736928406c9e649d7b558/horovod-0.19.4.tar.gz
...
%prep
%setup -q -n horovod-0.19.4
cd %{_builddir}/horovod-0.19.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590761733
...
cp %{_builddir}/horovod-0.19.4/LICENSE %{buildroot}/usr/share/package-licenses/horovod/bbce9e5e2c16889a1fdf197556e6b052e337a895
cp %{_builddir}/horovod-0.19.4/third_party/lbfgs/LICENSE.md %{buildroot}/usr/share/package-licenses/horovod/5fc0d512fe8797e2ba125c646447ce451689a129
